...
import ModalCriarPeriodo from './ModalCriarPeriodoAusencia.vue';
import ModalEditarPeriodo from './ModalEditarPeriodoAusencia.vue';
import ModalExcluirPeriodo from './ModalExcluirPeriodoAusencia.vue';
    ...
    computed: {
        filteredRows() {
            ...
            return this.periodos_ausencia.filter((periodos) => {
                ...
                if (justificativa.includes(searchTerm_justificativa)) {
                    contador_de_filtro++;
